...
public class RequiredParameter : IParameter
{
    ...
    public RequiredParameter(int requestedOrder, Location location, int declaredOrder, string name, string csharpTypeName, string initalizerLiteral, string initializerString)
    {
    ...
    public string InitializerLiteral { get; set; }
